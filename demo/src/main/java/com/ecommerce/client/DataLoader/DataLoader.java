...
public class DataLoader {
    ...
    public DataLoader(IRepository repository) throws Exception {
    ...
    public void saveDefaultUsers(){
        ...
        try {
            repository.saveUser(new User("customer", "customer", RoleType.CUSTOMER));
        } catch (Exception e) {
            e.printStackTrace();
        }

    }
    public void saveDefaultProducts() throws Exception {
